...
//       fetch('https://www.food2fork.com/api/search?key=4efc27eb874419824a596bff941829c2')
//         .then((response) => { 
...
//     }
    ...
    renderItem = ({ item }) => {
         return <RecipeItem navigation={this.props.navigation} item={item} />;
  ...
  render() {
   const { navigation } = this.props;
    ...
    return (
      <SafeAreaView style={{ flex: 1, marginTop: 25, alignItems: 'center' }}>
        <FlatList 
          data={data} //{data.recipes}
          renderItem={this.renderItem} keyExtractor={this.keyExtractor} ListHeaderComponent={this.renderHeader}
          />
      </SafeAreaView>
    );
  }
